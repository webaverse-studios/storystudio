      ...
      <div className="App">
        <Router>
          ...
          <Routes>
            ...
            <Route path="Settings" element={<EntityListBox
              type={'setting'}
              header={"Settings"}
            />} />
            <Route path="Characters" element={<EntityListBox
              type={'character'}
              header={"Characters"}
            />} />
            <Route path="NPCs" element={<EntityListBox
              type={'npc'}
              header={"NPCs"}
            />} />
            <Route path="Objects" element={<EntityListBox
              type={'object'}
              header={"Objects"}
            />} />
            <Route path="Mobs" element={<EntityListBox
              type={'mob'}
              header={"Mobs"}
            />} />
            <Route path="Lorefiles" element={<EntityListBox
              type={'loreFiles'}
              header={"Lorefiles"}
            />} />
